...
parcelRegister("fzNu7", function(module, exports) {

$parcel$export(module.exports, "ESP32C2ROM", () => $b570828cc1c2e664$export$8ad31a2aa21b3abf);

var $av8Kd = parcelRequire("av8Kd");

var $gvXjs = parcelRequire("gvXjs");
class $b570828cc1c2e664$export$8ad31a2aa21b3abf extends (0, $av8Kd.ESP32C3ROM) {
    constructor(){
        super(...arguments);
        ...
        this.TEXT_START = (0, (/*@__PURE__*/$parcel$interopDefault($gvXjs))).text_start;
        this.ENTRY = (0, (/*@__PURE__*/$parcel$interopDefault($gvXjs))).entry;
        this.DATA_START = (0, (/*@__PURE__*/$parcel$interopDefault($gvXjs))).data_start;
        this.ROM_DATA = (0, (/*@__PURE__*/$parcel$interopDefault($gvXjs))).data;
        this.ROM_TEXT = (0, (/*@__PURE__*/$parcel$interopDefault($gvXjs))).text;
    }
...
parcelRegister("gvXjs", function(module, exports) {
...
//# sourceMappingURL=esp32c2.09c36777.js.map

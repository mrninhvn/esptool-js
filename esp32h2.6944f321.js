...
parcelRegister("xIyQq", function(module, exports) {

$parcel$export(module.exports, "ESP32H2ROM", () => $0655a612186cd2f7$export$2184cd7dbcdab15a);

var $9P8lG = parcelRequire("9P8lG");

var $h52TY = parcelRequire("h52TY");
class $0655a612186cd2f7$export$2184cd7dbcdab15a extends (0, $9P8lG.ROM) {
    constructor(){
        super(...arguments);
        ...
        this.TEXT_START = (0, (/*@__PURE__*/$parcel$interopDefault($h52TY))).text_start;
        this.ENTRY = (0, (/*@__PURE__*/$parcel$interopDefault($h52TY))).entry;
        this.DATA_START = (0, (/*@__PURE__*/$parcel$interopDefault($h52TY))).data_start;
        this.ROM_DATA = (0, (/*@__PURE__*/$parcel$interopDefault($h52TY))).data;
        this.ROM_TEXT = (0, (/*@__PURE__*/$parcel$interopDefault($h52TY))).text;
    }
...
parcelRegister("h52TY", function(module, exports) {
...
//# sourceMappingURL=esp32h2.6944f321.js.map

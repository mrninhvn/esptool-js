...
parcelRegister("glfeh", function(module, exports) {

$parcel$export(module.exports, "ESP32S3ROM", () => $be5a6bc115869ec7$export$e18277a04821a5e);

var $9P8lG = parcelRequire("9P8lG");

var $1tN2g = parcelRequire("1tN2g");
class $be5a6bc115869ec7$export$e18277a04821a5e extends (0, $9P8lG.ROM) {
    constructor(){
        super(...arguments);
        ...
        this.TEXT_START = (0, (/*@__PURE__*/$parcel$interopDefault($1tN2g))).text_start;
        this.ENTRY = (0, (/*@__PURE__*/$parcel$interopDefault($1tN2g))).entry;
        this.DATA_START = (0, (/*@__PURE__*/$parcel$interopDefault($1tN2g))).data_start;
        this.ROM_DATA = (0, (/*@__PURE__*/$parcel$interopDefault($1tN2g))).data;
        this.ROM_TEXT = (0, (/*@__PURE__*/$parcel$interopDefault($1tN2g))).text;
    }
...
parcelRegister("1tN2g", function(module, exports) {
...
//# sourceMappingURL=esp32s3.6496fb4d.js.map

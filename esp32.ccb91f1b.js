...
parcelRegister("tPD5K", function(module, exports) {

$parcel$export(module.exports, "ESP32ROM", () => $059ac2180a4e85c6$export$e09e2fba47679cf2);

var $9P8lG = parcelRequire("9P8lG");

var $5iilt = parcelRequire("5iilt");
class $059ac2180a4e85c6$export$e09e2fba47679cf2 extends (0, $9P8lG.ROM) {
    constructor(){
        super(...arguments);
        ...
        this.TEXT_START = (0, (/*@__PURE__*/$parcel$interopDefault($5iilt))).text_start;
        this.ENTRY = (0, (/*@__PURE__*/$parcel$interopDefault($5iilt))).entry;
        this.DATA_START = (0, (/*@__PURE__*/$parcel$interopDefault($5iilt))).data_start;
        this.ROM_DATA = (0, (/*@__PURE__*/$parcel$interopDefault($5iilt))).data;
        this.ROM_TEXT = (0, (/*@__PURE__*/$parcel$interopDefault($5iilt))).text;
    }
...
parcelRegister("5iilt", function(module, exports) {
...
//# sourceMappingURL=esp32.ccb91f1b.js.map

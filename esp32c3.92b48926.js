...
parcelRegister("av8Kd", function(module, exports) {

$parcel$export(module.exports, "ESP32C3ROM", () => $7a53951271dfed75$export$d17dfcbab3a5ba52);

var $9P8lG = parcelRequire("9P8lG");

var $lL3hK = parcelRequire("lL3hK");
class $7a53951271dfed75$export$d17dfcbab3a5ba52 extends (0, $9P8lG.ROM) {
    constructor(){
        super(...arguments);
        ...
        this.TEXT_START = (0, (/*@__PURE__*/$parcel$interopDefault($lL3hK))).text_start;
        this.ENTRY = (0, (/*@__PURE__*/$parcel$interopDefault($lL3hK))).entry;
        this.DATA_START = (0, (/*@__PURE__*/$parcel$interopDefault($lL3hK))).data_start;
        this.ROM_DATA = (0, (/*@__PURE__*/$parcel$interopDefault($lL3hK))).data;
        this.ROM_TEXT = (0, (/*@__PURE__*/$parcel$interopDefault($lL3hK))).text;
    }
...
parcelRegister("lL3hK", function(module, exports) {
...
//# sourceMappingURL=esp32c3.92b48926.js.map
